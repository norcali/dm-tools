...
ActiveRecord::Schema.define(version: 20170516142320) do
  ...
  create_table "ability_scores", force: :cascade do |t|
    ...
    t.index ["character_stat_id"], name: "index_ability_scores_on_character_stat_id"
  end
  ...
  create_table "character_stats", force: :cascade do |t|
    ...
    t.integer "skill_id"
    t.index ["saving_throw_id"], name: "index_character_stats_on_saving_throw_id"
    t.index ["skill_id"], name: "index_character_stats_on_skill_id"
  end
  ...
  create_table "characters", force: :cascade do |t|
    ...
    t.index ["character_stat_id"], name: "index_characters_on_character_stat_id"
  ...
  create_table "features_klasses", id: false, force: :cascade do |t|
    t.integer "klass_id"
    t.integer "feature_id"
    t.index ["feature_id"], name: "index_features_klasses_on_feature_id"
    t.index ["klass_id"], name: "index_features_klasses_on_klass_id"
  end
